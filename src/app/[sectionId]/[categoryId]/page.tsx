...
export default function CategoryPage({ params, searchParams }: PageProps) {
  ...
  // Agar query kerak bo‘lsa, kerak joylarda Client ichida useSearchParams bilan ishlatasiz.
  // Bu yerda hech narsa uzatmaymiz, toki prop-typelarga tegmasin.

  return (
    <CategoryLayout title={title}>
      {/* Client komponent Suspense ichida */}
